        ...
        <div className='container mx-auto'>
          <div className='flex items-center justify-between lg:px-4 relative'>
            ...
            <nav className="lg:hidden">
              <svg style={{ width: '40px', height: '40px' }} onClick={() => setIsHamburgerOpen(!isHamburgerOpen)} className='cursor-pointer' width="30" height="20" viewBox="0 0 30 20" fill="none" xmlns="http://www.w3.org/2000/svg">
